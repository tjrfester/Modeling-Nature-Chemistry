...
Here I will store Pov-Ray scripts and -approaches for modeling chemical structures. Let's start with modeling atoms! Or let's better say modeling electron envelopes. I will include scripts and images for the 1s, the 2s and the 2py-orbital. There will be a video covering the theoretic background for this in my youtube channel. 
1s-Orbital (section)
...
My first structure is a fullerene. For a description of this structure, have a look at the upcoming youtube video. 
